...
parser.add_argument('--adv_neuron_percent', type=float, default=100.0,
                    help='Top input-channel percentage in (0,100]; 100 preserves the original PGD.')
parser.add_argument('--adv_neuron_refresh', choices=('step', 'batch'), default='step',
                    help='Re-rank channels each PGD step, or once per training batch.')
