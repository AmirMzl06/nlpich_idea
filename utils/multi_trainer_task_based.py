...
from utils.multi_model_task_based import Encoder_Decoder_Multi
import os
import numpy as np
...
def train_model(args):
    ...
    for session_name, decoder_name, neural_dim, out_dim, (train_loader, test_loader, loaded_data) in all_loaders:
        model.add_session_encoder(session_name, neural_dim)
        model.add_session_decoder(decoder_name, out_dim)
